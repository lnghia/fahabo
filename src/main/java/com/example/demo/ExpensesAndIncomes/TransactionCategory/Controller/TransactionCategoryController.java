...
public class TransactionCategoryController {
    ...
    @Autowired
    private CTransactionHelper CTransactionHelper;
...
//                TransactionCategoryGroup transactionCategoryGroup = transactionCategoryGroupService.findById(Integer.parseInt(reqBody.parentId));
                String iconUrl = CTransactionHelper.addIconToCategory(reqBody.icon, reqBody.name, reqBody.familyId);
                ...
                return ResponseEntity.ok(new Response(transactionCategory.getJson(iconUrl), new ArrayList<>()));
